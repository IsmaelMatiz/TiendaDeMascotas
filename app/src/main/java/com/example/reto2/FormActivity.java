...
public class FormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnInsertar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(verificarVacios()){
                    try {
                        llenarCampos();
                        dbHelper.insertData(campo1Insert, campo2Insert, campo3Insert, imageInsert, name, campo4Insert);
                        limpiarCampos();
                        Toast.makeText(getApplicationContext(), "La imagen se ha agregado a la lista", Toast.LENGTH_SHORT).show();
                    }catch (Exception e){
        ...
        btnConsultar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                while (cursor.moveToNext()){
                    ...
                    campo4Insert = cursor.getString(5);
                    Toast.makeText(getApplicationContext(), "La imagen ha sido traida", Toast.LENGTH_SHORT).show();
                    existenciaId = true;
                }
                if (!existenciaId){
                    Toast.makeText(getBaseContext(), "El elemento no existe", Toast.LENGTH_SHORT).show();
                }
                if (campo4Insert.equals("1")){
                    btnFav.setImageResource(btn_star_on);
                }else {
                    btnFav.setImageResource(R.drawable.ic_baseline_star_24);
                }
                }else {
                    Toast.makeText(getBaseContext(), "Debe haber un id en la celda", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnEliminar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(verificarId() && verificarExistenciaId(editId.getText().toString().trim())) {
                    ...
                    Toast.makeText(getBaseContext(), "EL id está vacio o no existe", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnActualizar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(verificarVacios() && verificarId()){
                    if (verificarExistenciaId(editId.getText().toString().toString())){
                    llenarCampos();
                    try{
                        ...
                        Toast.makeText(getBaseContext(), "La id no existe", Toast.LENGTH_SHORT).show();
                    }
                }else {
                    Toast.makeText(getBaseContext(), "has dejando una celda vacia", Toast.LENGTH_SHORT).show();
                }
